...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float curSpeedX = canMove ? (isRunning ? runningSpeed : (isCrouching ? crouchingSpeed : walkingSpeed)) * Input.GetAxis("Vertical") : 0;     //fix long crap with state machine later probably
